...
angular.module("platen.services").factory("settings", function() {
    ...
    var FONTS = [ "serif", "sans-serif", "arvo", "cabin", "crimson text", "droid sans", "droid serif", "droid sans mono", "economica", "francois one", "goudy", "inconsolata", "josefin sans", "josefin slab", "libre baskerville", "lobster", "lobster two", "maven pro", "merriweather sans", "open sans", "oswald", "PT sans", "PT serif", "PT mono", "ubuntu", "ubuntu mono" ];
    return {
        themes: THEMES,
        defaults: DEFAULTS,
        fonts: FONTS,
...
angular.module("platen.services").factory("wordpress", [ "$dialog", "$rootScope", "logger", function($dialog, $rootScope, logger) {
    var POST_TYPE = "post";
